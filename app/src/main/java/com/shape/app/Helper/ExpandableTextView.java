...
public class ExpandableTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private static final String ELLIPSIS ="<u>...Read More<u>";;
    ...
    private CharSequence getTrimmedText(CharSequence text) {
        if (originalText != null && originalText.length() > trimLength) {
            return new SpannableStringBuilder(originalText, 0, trimLength + 1).append(getContext().getString(R.string.seemore));
        } else {
            return originalText;
        }
    }
