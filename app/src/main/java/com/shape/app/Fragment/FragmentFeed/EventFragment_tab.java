...
public class EventFragment_tab extends Fragment implements Fragment_Data_Send {
    ...
    public void onResume() {
        ...
        if (Constant.isNetworkAvailable(getActivity())) {
            getEventList();
           // Toast.makeText(getActivity(), "all 2_resume", Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (code.equals("200")) {
                       ...
                       // recyclerView_event.setAdapter(new FeedTabAdapter(eventTabModelArrayList, (AppCompatActivity) getActivity()));
