...
public class AllFeedFragment extends Fragment implements Fragment_Data_Send {

    public static Fragment newInstance() {
        EventFragment_tab fragment = new EventFragment_tab();
        return fragment;
   ...
   // ArrayList<EventTabModel> data_list;
    ...
    public void onResume() {
        ...
        if (Constant.isNetworkAvailable(getActivity())) {
            getEventList();
           // Toast.makeText(getActivity(), "all_resume", Toast.LENGTH_SHORT).show();

            Log.d("tag_size", "onCreateView: " + eventTabModelArrayList.size());
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (code.equals("200")) {
                        ...
                        ArrayList<EventTabModel> temp_list = new ArrayList();
                        ...
                        for (int i = 0; i < jsonArrayvideo.length(); i++) {
                            ...
                            Log.d("inside_tag_l", "onCreateView: " + jsonArrayvideo.length());
                        ...
                        Log.d("inside_tag_j", "onCreateView: " + eventTabModelArrayList.size());

                        if (!temp_list.isEmpty()) {
                            eventTabModelArrayList.addAll(temp_list);
                            Set_Adapter();
                        }
                    } else {
    ...
    public void Set_Adapter() {
        ...
        adapter = new FeedTabAdapter(getActivity(), eventTabModelArrayList, new FeedTabAdapter.OnItemClickListener() {
            @Override
...
//        EventTabModel item = data_list.get(-1);
//        item.total_comment = "" + comment_count;
//        data_list.remove(-1);
//        data_list.add(-1, item);
