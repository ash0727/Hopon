 ...
 * Use the {@link KnowledgeHub_tab#newInstance} factory method to
 * create an instance of this fragment.
 */
public class KnowledgeHub_tab extends Fragment implements Fragment_Data_Send {
    public static Fragment newInstance() {
        KnowledgeHub_tab fragment = new KnowledgeHub_tab();
        return fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_knowledge_hub_tab, container, false);
        SherfPrefes();
    ...
    public void onResume() {
        ...
        if (Constant.isNetworkAvailable(getActivity())) {
            getEventList();
           // Toast.makeText(getActivity(), "all 3_resume", Toast.LENGTH_SHORT).show();
    ...
    private void getEventList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.FEED_LIST_TAB, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("feed_type", "Knowledge_Hub");
